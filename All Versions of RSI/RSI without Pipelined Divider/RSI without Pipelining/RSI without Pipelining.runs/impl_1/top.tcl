...
set rc [catch {
  ...
  add_files -quiet {{C:/Abdullah Data/Final Implemented Design/RSI without Pipelined Divider/RSI without Pipelining/RSI without Pipelining.runs/synth_1/top.dcp}}
